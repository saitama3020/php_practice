...
<html lang="ja">
  ...
  <body>
    ...
    <form action="update.php" method="post">
      ...
      value="<?php echo htmlspecialchars($result['recipe_name'], ENT_QUOTES,
              'UTF-8'); ?>"><br>
      カテゴリ：
      <select name="category">
        <option value="">選択してください。</option>
        <option value="1" <?php if($result['category'] === 2) echo "selected"; ?> >和食</option>
        <option value="2" <?php if($result['category'] === 3) echo "selected"; ?> >中華</option>
      ...
      <br>
      予算：<input type="number" name="budget" min="1" max="9999" value="<?php echo htmlspecialchars($result['budget'], ENT_QUOTES, 'UTF-8'); ?>"  >円
      <br>
      作り方：
      <textarea name="howto" cols="40" rows="4" maxlength="150">
